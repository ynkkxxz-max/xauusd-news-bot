        ...
        for u in updates:
            ...
            bottom_keyboard = {
                "keyboard": [
                    [
                        {"text": "Price"},
                        {"text": "SMC", "web_app": {"url": "https://ynkkxxz-max.github.io/xauusd-news-bot/?v=118&tab=smc"}}
                    ]
                ],
            ...
            if clean_cmd in ("/lot", "/risk", "lot", "risk") or "lot" in text.lower() or "risk" in text.lower() or "គិត" in text:
                ...
                smc_inline_buttons = {
                    "inline_keyboard": [
                        [
                            {"text": "📱 បើក Mini App (Live SMC Terminal)", "url": "https://ynkkxxz-max.github.io/xauusd-news-bot/?v=118&tab=smc"}
                        ],
                        [
                            {"text": "📊 មើល TradingView Live Chart", "url": "https://ynkkxxz-max.github.io/xauusd-news-bot/?v=118&tab=chart"},
                            {"text": "🧮 គិត Lot Size", "url": "https://ynkkxxz-max.github.io/xauusd-news-bot/?v=118&tab=lot"}
                        ]
                    ]
                }
